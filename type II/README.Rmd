...
Asymptotic type II error rates for LRTesteR's likelihood ratio tests are estimated via simulation. Calculations are based on 2,000 iterations and a sample size of 200. Simulation holds the null hypothesis constant across all alternatives and effect sizes. Where possible, exact tests are included for comparison.
...
typeII <- typeII %>%
  mutate(test = factor(test, levels = c("gaussian_mean_one_sample", "t.test", "gaussian_variance_one_sample", "varTest")))
