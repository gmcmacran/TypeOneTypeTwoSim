...
geomet <- bind_rows(
  readRDS("results/geometric_type_two.rds"),
  readRDS("results/geometric_type_two_exact.rds") %>%
...
It is interesting to note the likelihood test approximation worked very well. The test it is approximating is unusable.
