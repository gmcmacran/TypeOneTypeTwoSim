...
Like type I calculations, each simulated experiment is based on a sample size of 500. Each combination of effect size and test are repeated 2,000 times. Where possible, exact tests are included for comparison.
