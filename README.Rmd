...
## Type II Error Rate
For distributions that have an exact test implemented in R, type II error rate was calculated over a range of effect sizes. The likelihood tests match the exact tests type II error rates.
...
ggplot(temp, aes(x = TypeII, y = test2, color = factor(type))) + 
  ...
  labs(x = "Type II Error Rate", y = "Test", color = "Type")
...
In the aggregate, type I error rate is below the desired .05 for two tests. This is due to the discrete nature of the test statistic. 
