...
# Repo Overview
This repo is a simulation study of statistical properties for hypothesis tests in LRTesteR. Each row is an experiment where data are generated from random generators and hypothesis test done. The first five rows look like
