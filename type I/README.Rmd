...
Over the entire range of p, the likelihood ratio has type I error rate far from the desired .05. Sometimes the likelihood test is liberal. Sometimes it is conservative.
...
In the aggregate, type I error rate is below the desired .05 for two alternatives. This is due to the discrete nature of the test statistic. 
