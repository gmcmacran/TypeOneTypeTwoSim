...
Over the entire range of p, the likelihood ratio test has type I error rate far from the desired .05. Sometimes the likelihood test is liberal. Sometimes it is conservative. The exact test is always below .05 but is not very conservative.
...
For the likelihood ratio test, the aggregate type I error rate is below the desired .05 for two alternatives. The exact test is conservative for all alternatives. 
